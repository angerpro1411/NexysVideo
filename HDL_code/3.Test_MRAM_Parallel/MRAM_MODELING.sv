...
////////////////// Testing without delay ///////////////////////////
    ...
    // ----------------------------------------------------------
    always @(*) begin
        if (E_n)        UB_EN = 1'b0; // Chip disabled ? Hi-Z after tEHQZ
        else if (G_n)   UB_EN = 1'b0; // Output disabled ? Hi-Z after tGHQZ
        else if (UB_n)  UB_EN = 1'b0; // Upper byte disabled ? Hi-Z after tBHQZ
        else if (!W_n)  UB_EN = 1'b0; // Write mode ? bus turnaround, Hi-Z after tWLQZ
        else            UB_EN = 1'b1; // All conditions met ? output active
    end
    ...
    always @(*) begin
        if (E_n)        LB_EN = 1'b0;
        else if (G_n)   LB_EN = 1'b0;
        else if (LB_n)  LB_EN = 1'b0;
        else if (!W_n)  LB_EN = 1'b0;
        else            LB_EN = 1'b1;
    end
